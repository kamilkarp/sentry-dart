...
- Bump Android SDK from v8.12.0 to v8.29.0 ([#43](https://github.com/kamilkarp/sentry-dart/pull/43))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8290)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.29.0)
