...
- Bump Android SDK from v8.12.0 to v8.39.0 ([#79](https://github.com/kamilkarp/sentry-dart/pull/79))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8390)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.39.0)
