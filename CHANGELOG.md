...
- Bump Native SDK from v0.9.0 to v0.12.7 ([#55](https://github.com/kamilkarp/sentry-dart/pull/55))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0127)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.9.0...0.12.7)
