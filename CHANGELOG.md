...
- Bump Cocoa SDK from v8.52.1 to v9.5.0 ([#58](https://github.com/kamilkarp/sentry-dart/pull/58))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#950)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.52.1...9.5.0)
