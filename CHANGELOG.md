...
- Bump Android SDK from v8.12.0 to v8.24.0 ([#29](https://github.com/kamilkarp/sentry-dart/pull/29))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8240)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.24.0)
