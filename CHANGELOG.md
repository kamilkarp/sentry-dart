...
- Bump Cocoa SDK from v8.52.1 to v9.3.0 ([#49](https://github.com/kamilkarp/sentry-dart/pull/49))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#930)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.52.1...9.3.0)
