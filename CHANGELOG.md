...
- Bump Native SDK from v0.9.0 to v0.15.2 ([#106](https://github.com/kamilkarp/sentry-dart/pull/106))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0152)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.9.0...0.15.2)
