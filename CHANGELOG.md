...
- Bump Android SDK from v8.12.0 to v8.19.0 ([#10](https://github.com/kamilkarp/sentry-dart/pull/10))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8190)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.19.0)
