...
- Bump Native SDK from v0.9.0 to v0.17.0 ([#144](https://github.com/kamilkarp/sentry-dart/pull/144))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0170)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.9.0...0.17.0)
