...
- Bump Native SDK from v0.9.0 to v0.13.6 ([#78](https://github.com/kamilkarp/sentry-dart/pull/78))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0136)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.9.0...0.13.6)
