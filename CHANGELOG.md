...
- Bump Android SDK from v8.12.0 to v8.46.0 ([#109](https://github.com/kamilkarp/sentry-dart/pull/109))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8460)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.46.0)
