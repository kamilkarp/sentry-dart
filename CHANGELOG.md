...
- Bump Native SDK from v0.9.0 to v0.12.3 ([#44](https://github.com/kamilkarp/sentry-dart/pull/44))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0123)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.9.0...0.12.3)
