...
- Bump Android SDK from v8.12.0 to v8.33.0 ([#57](https://github.com/kamilkarp/sentry-dart/pull/57))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8330)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.33.0)
