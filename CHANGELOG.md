...
- Bump Cocoa SDK from v8.52.1 to v9.4.0 ([#51](https://github.com/kamilkarp/sentry-dart/pull/51))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#940)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.52.1...9.4.0)
