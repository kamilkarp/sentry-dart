...
- Bump Cocoa SDK from v8.52.1 to v9.7.0 ([#66](https://github.com/kamilkarp/sentry-dart/pull/66))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#970)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.52.1...9.7.0)
