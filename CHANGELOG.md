...
- Bump Native SDK from v0.9.0 to v0.15.0 ([#100](https://github.com/kamilkarp/sentry-dart/pull/100))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0150)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.9.0...0.15.0)
