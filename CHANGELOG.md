...
- Bump Android SDK from v8.12.0 to v8.53.0 ([#129](https://github.com/kamilkarp/sentry-dart/pull/129))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8530)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.53.0)
