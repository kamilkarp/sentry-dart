...
- Bump Android SDK from v8.12.0 to v8.42.0 ([#92](https://github.com/kamilkarp/sentry-dart/pull/92))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8420)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.42.0)
