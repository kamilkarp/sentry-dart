...
- Bump Native SDK from v0.9.0 to v0.13.5 ([#75](https://github.com/kamilkarp/sentry-dart/pull/75))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0135)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.9.0...0.13.5)
