...
- Bump Android SDK from v8.12.0 to v8.49.0 ([#117](https://github.com/kamilkarp/sentry-dart/pull/117))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8490)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.49.0)
