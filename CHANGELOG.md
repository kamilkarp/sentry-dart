...
- Bump Cocoa SDK from v8.52.1 to v9.1.0 ([#42](https://github.com/kamilkarp/sentry-dart/pull/42))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#910)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.52.1...9.1.0)
