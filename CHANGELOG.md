...
- Bump Android SDK from v8.12.0 to v8.44.1 ([#105](https://github.com/kamilkarp/sentry-dart/pull/105))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8441)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.44.1)
