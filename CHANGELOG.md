...
- Bump Android SDK from v8.12.0 to v8.52.0 ([#126](https://github.com/kamilkarp/sentry-dart/pull/126))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8520)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.52.0)
