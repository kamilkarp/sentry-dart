...
- Bump Android SDK from v8.12.0 to v8.50.0 ([#119](https://github.com/kamilkarp/sentry-dart/pull/119))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8500)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.50.0)
