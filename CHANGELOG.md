...
- Bump Native SDK from v0.9.0 to v0.14.2 ([#91](https://github.com/kamilkarp/sentry-dart/pull/91))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0142)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.9.0...0.14.2)
