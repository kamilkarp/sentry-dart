...
- Bump Android SDK from v8.12.0 to v8.41.0 ([#87](https://github.com/kamilkarp/sentry-dart/pull/87))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8410)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.41.0)
