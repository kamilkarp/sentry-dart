...
- Bump Cocoa SDK from v8.52.1 to v9.5.1 ([#60](https://github.com/kamilkarp/sentry-dart/pull/60))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#951)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.52.1...9.5.1)
