...
- Bump Native SDK from v0.9.0 to v0.17.1 ([#146](https://github.com/kamilkarp/sentry-dart/pull/146))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0171)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.9.0...0.17.1)
