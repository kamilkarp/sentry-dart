...
- Bump Native SDK from v0.9.0 to v0.13.2 ([#65](https://github.com/kamilkarp/sentry-dart/pull/65))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0132)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.9.0...0.13.2)
