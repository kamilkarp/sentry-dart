...
- Bump Android SDK from v8.12.0 to v8.21.1 ([#18](https://github.com/kamilkarp/sentry-dart/pull/18))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8211)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.21.1)
