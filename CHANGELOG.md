...
- Bump Cocoa SDK from v8.52.1 to v9.0.0 ([#40](https://github.com/kamilkarp/sentry-dart/pull/40))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#900)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.52.1...9.0.0)
