...
- Bump Android SDK from v8.12.0 to v8.51.0 ([#123](https://github.com/kamilkarp/sentry-dart/pull/123))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8510)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.51.0)
