...
- Bump Native SDK from v0.9.0 to v0.11.3 ([#27](https://github.com/kamilkarp/sentry-dart/pull/27))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0113)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.9.0...0.11.3)
