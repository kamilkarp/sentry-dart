...
- Bump Cocoa SDK from v8.52.1 to v9.10.0 ([#77](https://github.com/kamilkarp/sentry-dart/pull/77))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#9100)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.52.1...9.10.0)
