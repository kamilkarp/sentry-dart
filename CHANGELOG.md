...
- Bump Android SDK from v8.12.0 to v8.30.0 ([#45](https://github.com/kamilkarp/sentry-dart/pull/45))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8300)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.30.0)
