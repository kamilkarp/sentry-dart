...
- Bump Cocoa SDK from v8.52.1 to v9.6.0 ([#63](https://github.com/kamilkarp/sentry-dart/pull/63))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#960)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.52.1...9.6.0)
