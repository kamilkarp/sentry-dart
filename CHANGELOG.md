...
- Bump Android SDK from v8.12.0 to v8.27.1 ([#38](https://github.com/kamilkarp/sentry-dart/pull/38))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8271)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.27.1)
