...
- Bump Android SDK from v8.12.0 to v8.28.0 ([#41](https://github.com/kamilkarp/sentry-dart/pull/41))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8280)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.28.0)
