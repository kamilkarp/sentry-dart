...
- Bump Android SDK from v8.12.0 to v8.23.0 ([#25](https://github.com/kamilkarp/sentry-dart/pull/25))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8230)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.23.0)
