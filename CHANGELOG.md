...
- Bump Native SDK from v0.9.0 to v0.15.3 ([#112](https://github.com/kamilkarp/sentry-dart/pull/112))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0153)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.9.0...0.15.3)
