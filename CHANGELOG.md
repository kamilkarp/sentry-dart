...
- Bump Android SDK from v8.12.0 to v8.27.0 ([#37](https://github.com/kamilkarp/sentry-dart/pull/37))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8270)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.27.0)
