...
- Bump Native SDK from v0.9.0 to v0.11.0 ([#20](https://github.com/kamilkarp/sentry-dart/pull/20))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0110)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.9.0...0.11.0)
