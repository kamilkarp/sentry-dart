...
- Bump Native SDK from v0.9.0 to v0.14.1 ([#90](https://github.com/kamilkarp/sentry-dart/pull/90))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0141)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.9.0...0.14.1)
