...
- Bump Android SDK from v8.12.0 to v8.34.1 ([#64](https://github.com/kamilkarp/sentry-dart/pull/64))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8341)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.34.1)
