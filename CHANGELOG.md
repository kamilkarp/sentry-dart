...
- Bump Android SDK from v8.12.0 to v8.36.0 ([#68](https://github.com/kamilkarp/sentry-dart/pull/68))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8360)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.36.0)
