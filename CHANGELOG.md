...
- Bump Android SDK from v8.12.0 to v8.44.0 ([#102](https://github.com/kamilkarp/sentry-dart/pull/102))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8440)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.44.0)
