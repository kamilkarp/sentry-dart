...
- Bump Android SDK from v8.12.0 to v8.38.0 ([#76](https://github.com/kamilkarp/sentry-dart/pull/76))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8380)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.38.0)
