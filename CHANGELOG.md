...
- Bump Android SDK from v8.12.0 to v8.35.0 ([#67](https://github.com/kamilkarp/sentry-dart/pull/67))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8350)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.35.0)
