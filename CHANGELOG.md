...
- Bump Android SDK from v8.12.0 to v8.32.0 ([#53](https://github.com/kamilkarp/sentry-dart/pull/53))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8320)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.32.0)
