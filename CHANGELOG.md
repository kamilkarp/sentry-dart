...
- Bump Cocoa SDK from v8.52.1 to v8.56.2 ([#24](https://github.com/kamilkarp/sentry-dart/pull/24))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#8562)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.52.1...8.56.2)
