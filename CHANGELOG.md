...
- Bump Android SDK from v8.12.0 to v8.40.0 ([#82](https://github.com/kamilkarp/sentry-dart/pull/82))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8400)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.40.0)
