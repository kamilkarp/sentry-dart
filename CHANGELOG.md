...
- Bump Native SDK from v0.9.0 to v0.13.0 ([#59](https://github.com/kamilkarp/sentry-dart/pull/59))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0130)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.9.0...0.13.0)
