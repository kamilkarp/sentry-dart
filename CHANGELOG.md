...
- Bump Android SDK from v8.12.0 to v8.18.0 ([#8](https://github.com/kamilkarp/sentry-dart/pull/8))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8180)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.18.0)
