...
- Bump Cocoa SDK from v8.52.1 to v8.55.1 ([#16](https://github.com/kamilkarp/sentry-dart/pull/16))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#8551)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.52.1...8.55.1)
