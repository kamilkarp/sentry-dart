...
- Bump Android SDK from v8.12.0 to v8.56.0 ([#139](https://github.com/kamilkarp/sentry-dart/pull/139))
  - [changelog](https://github.com/getsentry/sentry-java/blob/9.x.x main/CHANGELOG.md#8560)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.56.0)
