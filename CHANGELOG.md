...
- Bump Android SDK from v8.12.0 to v8.25.0 ([#31](https://github.com/kamilkarp/sentry-dart/pull/31))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8250)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.12.0...8.25.0)
