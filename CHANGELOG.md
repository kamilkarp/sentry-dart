...
- Bump Native SDK from v0.9.0 to v0.16.0 ([#122](https://github.com/kamilkarp/sentry-dart/pull/122))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0160)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.9.0...0.16.0)
